											...
											<div class="col mr-2">
												...
												<div class="row  align-items-center">
													...
													<!--		<div class="form-group col-sm-5">
															  <select multiple="multiple"  class="form-control lstBox1" size="7">
																<?php 
															...
															<div class="row gy-2">
																...
																<i class="fas fa-angle-double-right fa-sm text-white-50"></i> </a><br />
															</div>
															...
															<div class="form-group col-sm-5">
															  <select multiple="multiple"  class="form-control lstBox2" size="7">
												...
												<div class="row  align-items-center">
													<div class="card-body">
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="extrusion">
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="printing">
														  <label class="form-check-label" for="flexCheckDefault">
															Printing
														  </label>
														</div>
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="1stlamination">
														  <label class="form-check-label" for="flexCheckDefault">
															1st Lamination
														  </label>
														</div>
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="2ndlamination">
														  <label class="form-check-label" for="flexCheckDefault">
															2nd Lamination
														  </label>
														</div>
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="slitting">
														  <label class="form-check-label" for="flexCheckDefault">
															Slitting
														  </label>
														</div>
														...
														<div class="form-check">
														  <input class="form-check-input" type="checkbox" value="" id="cuttingandbagging">
														  <label class="form-check-label" for="flexCheckDefault">
															Cutting and Bagging
														  </label>
														</div>
