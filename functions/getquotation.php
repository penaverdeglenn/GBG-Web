...
require_once __DIR__."/allfunctions.php";
    ...
    $strSQL = "SELECT * FROM tbl_sales_inquiry WHERE salesinquiry_status='Approved' AND sales_inquiry_id=".$si_id;
...
?>
															...
															<div class="row">
																	...
																	<div class="col-sm-3">
																		<p class="h5 sid"><b><?php echo $si_id; ?></b></p>
																	</div>
																	<div class="col-sm-3">
																		View Details:
																		<a type="button" target="_blank" class="btn btn-sm btn-primary shadow-sm" href="salesinquirydetails.php?action=edit&custid=<?php echo $cust_id; ?>&sid=<?php echo $si_id; ?>"><i class="far fa-eye"></i></a>
																	</div>
															</div>		
