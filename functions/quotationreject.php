...
$con = mysqli_connect(get_dbserver(),get_dbuser(),get_dbpassword(),get_dbname());
		...
		$strSQL = "UPDATE tbl_quotation SET quotation_status='Rejected',quotation_approver_1_response='Rejected',quotation_approver_1_date='".$dateToday."',quotation_approver_1_reject_reason='".$reason."' WHERE quotation_id=".$qidr;
