        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row shadow">
              <div class="col-lg-6 d-none d-lg-block"><img src="../css/gbg.jpg" width ="440" height="340"></image></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Please login to the system</h1>
                  </div>
