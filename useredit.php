							...
							<div class="col-lg-12">
								<div class="card border-left-info shadow h-100 py-2">
                                 ...
                                 <?php $resultlist = getuserlistdata($id);
                                    ...
                                    <input type="hidden" value="<?php echo $id; ?>" name="id" class="id" />
                              ...
                              <!--    <select class="form-control form-select gender" name="gender" id = "gender" aria-label="Default select example">
                                    ...
                                    <option <?php // if($row['GENDER']=="Male"){echo "selected"; }else {} ?> value="Male">Male</option>
                                    <option <?php // if($row['GENDER']=="Female"){echo "selected"; }else {} ?> value="Female">Female</option>
                                  </select> -->
                                 ...
                                 <div class="form-group col-12 row" >
                                   ...
                                   <div class="col-sm-3 row">
                                     <select class="form-control form-select dept" name="dept" id = "dept" aria-label="Default select example">
                                       ...
                                       <option <?php if($row['DEPARTMENT']=="Purchasing"){echo "selected"; }else {} ?> value="Purchasing">Purchasing</option>
                                       <option <?php if($row['DEPARTMENT']=="Manufacturing"){echo "selected"; }else {} ?>value="Manufacturing">Manufacturing</option>
                                       <option <?php if($row['DEPARTMENT']=="Accounting"){echo "selected"; }else {} ?> value="Accounting">Accounting</option>
                                     </select>
                                   ...
                                   <div class="col-sm-3 row" >
                                     <select class="form-control form-select usertype" name="usertype" id = "usertype" aria-label="Default select example">
                                        ...
                                        <option <?php if($row['USER_TYPE']=="Sales Associate"){echo "selected"; }else {} ?> value="Sales Associate">Sales Associate</option>
                                       <option <?php if($row['USER_TYPE']=="Approver 1"){echo "selected"; }else {} ?> value="Approver 1">Approver Level 1</option>
                                       <option <?php if($row['USER_TYPE']=="Approver 2"){echo "selected"; }else {} ?> value="Approver 2">Approver Level 2</option>
                                     </select>
                 ...
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                             ...
                             ?>
                              ...
                              <?php   if (in_array("Sales Inquiry", $str_arr)){ ?>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="Sales Inquiry" name="useraccess[]"   id="salesinquiry" checked="checked" readonly="true">
                              ...
                              <?php }else{ ?>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="Quotation"  checked="checked" name="useraccess[]" id="quotation">
                                  <label class="form-check-label" for="flexCheckDefault">
                                  Quotation
                                  </label>
                                </div>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="Sales Order" name="useraccess[]"  checked="checked" id="salesorder">
                                  <label class="form-check-label" for="flexCheckDefault">
                                  Sales Order
                                  </label>
                                </div>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="Job Order"  checked="checked" name="useraccess[]" id="joborder">
                                  <label class="form-check-label" for="flexCheckDefault">
                                  Job Order
                                  </label>
                                </div>
					...
					<div class="row gy-5 align-items-center">
						...
						<div class="col-lg-6">
              	<button type="button" class="btn btn-success btn-lg btn-block submitedituseraccount" >Submit</button>
						</div>
						</form>
